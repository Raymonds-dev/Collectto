// CollectionService - Interface for Collection operations
// This contract defines the API for creating, reading, and managing collections.
// Implementation can be mock (src/mocks/collections) or real API (future backend).
