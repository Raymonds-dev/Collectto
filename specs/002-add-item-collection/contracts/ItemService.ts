// ItemService - Interface for Item operations
// This contract defines the API for creating, reading, and managing items.
// Implementation can be mock (src/mocks/items) or real API (future backend).
